...
TEST( descriptor_building_and_serialization, base_descriptor_serialization_test)
{
  ...
  EventTypeDescriptor etd1(ENTRY_REQUIRED,rbl_int4(),true);
  EventTypeDescriptor etd2(ENTRY_OPTIONAL,rbl_int8(),false);
  EventTypeDescriptor etd3(ENTRY_REQUIRED,rbl_int4(),true);
  ...
  EXPECT_EQ(etb_out.TypeAt(0)->type(),get_type_ordinal_f<rbl_int4>::pos::value);
  EXPECT_EQ(etb_out.TypeAt(1)->type(),get_type_ordinal_f<rbl_int8>::pos::value);
  EXPECT_EQ(etb_out.TypeAt(2)->type(),get_type_ordinal_f<rbl_int4>::pos::value);
  ...
  EXPECT_EQ(ndb_out.EventAt(0)->TypeAt(0)->type(),get_type_ordinal_f<rbl_int4>::pos::value);
  EXPECT_EQ(ndb_out.EventAt(0)->TypeAt(1)->type(),get_type_ordinal_f<rbl_int8>::pos::value);
  EXPECT_EQ(ndb_out.EventAt(0)->TypeAt(2)->type(),get_type_ordinal_f<rbl_int4>::pos::value);
